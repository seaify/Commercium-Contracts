...
client = AccountClient(address=account_address, client=GatewayClient(net="mainnet"), key_pair=signer_key_pair, chain=StarknetChainId.MAINNET, supported_tx_version=1)
