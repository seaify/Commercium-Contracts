...
func multis_swap{
    ...
    let(trade_amount: Uint256) = IERC20.balanceOf(_path[0].token_in,_this_address)

    ITrade_executor.swap_single(_trade_executor_address,_path[0].router,trade_amount,_path[0].token_in,_path[0].token_out,_this_address)
    
    multis_swap(_path_len-1,_path+1,_trade_executor_address,_this_address)
